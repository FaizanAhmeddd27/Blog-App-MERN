...
const TrendingCard = ({ image, title, adminName, adminPhoto, category, about }) => {
  return (
    <div className="w-full max-w-xs sm:max-w-xsm md:max-w-sm lg:max-w-sm mb-4 bg-white rounded-xl overflow-hidden transform transition duration-300 hover:scale-105 shadow-md hover:shadow-[0_10px_25px_rgba(0,0,0,0.4)] group mx-auto">
